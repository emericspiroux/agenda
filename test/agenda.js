  ...
  describe("job methods", () => {
    ...
    describe("every", () => {
      describe("with a job name specified", () => {
        ...
        it("sets the repeatEvery", () => {
          expect(
            jobs.every("5 seconds", "send email").attrs.repeatInterval
          ).to.be("5 seconds");
        });
        it("sets the agenda", () => {
      ...
      describe("with array of names specified", () => {
        it("returns array of jobs", () => {
          expect(jobs.every("5 minutes", ["send email", "some job"])).to.be.an(
            "array"
          );
        });
      });
    ...
    describe("schedule", () => {
      describe("with a job name specified", () => {
        ...
        it("sets the schedule", () => {
          ...
          expect(
            jobs
              .schedule("in 5 minutes", "send email")
              .attrs.nextRunAt.valueOf()
          ).to.be.greaterThan(fiveish);
        });
      });
      describe("with array of names specified", () => {
        it("returns array of jobs", () => {
          expect(
            jobs.schedule("5 minutes", ["send email", "some job"])
          ).to.be.an("array");
        });
      });
    });
    ...
    describe("now", () => {
      ...
      it("sets the schedule", () => {
        const now = new Date();
        expect(
          jobs.now("send email").attrs.nextRunAt.valueOf()
